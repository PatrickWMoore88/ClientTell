...
// // // // // // Get A Single Lead
router.get('/get/leads/:id', async (req, res) => {
...
router.get('/create/leads', async (req, res) => {
  try {
...
// // // // // // Delete Given Lead
router.post('/delete/leads/:id', async (req, res) => {
...
router.post('/update/leads/:id', async (req, res) => {
